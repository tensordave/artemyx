...
- [v0.3](changelogs/v0.3.md) - OPFS persistence, examples framework, sandbox mode
- [v0.2](changelogs/v0.2.md) - Landing page, spatial operations, layers config, expression styling
- [v0.1](changelogs/v0.1.md) - Initial release, declarative GIS with in-browser spatial operations
