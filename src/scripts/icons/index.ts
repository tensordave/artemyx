// Icon registry — all icons are Phosphor SVG strings (Regular weight unless noted)
...
export { tableIcon } from './table';                       // tabular view
export { rulerIcon } from './ruler';                       // measurement tools
